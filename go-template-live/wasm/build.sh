...
# - functions_confd.go: included when NOT building with "official" tag
...
GOOS=js GOARCH=wasm go build -o confd.wasm .
...
echo ""
echo "File sizes:"
ls -lh official.wasm custom.wasm confd.wasm 2>/dev/null || ls -lh *.wasm
